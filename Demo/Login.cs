...
namespace Demo
{
    public partial class Login : Form
    {
        ...
        private Multiplayer multiplayerMenu;
        ...
        public Login()
        {
            ...
            multiplayerMenu = new Multiplayer();
            ...
            title.Location = new Point(this.Width / 2 - buttonX / 3, this.Height / 16);
            title.Text = "Login";
            title.AutoSize = true;
            ...
            login.Location = new System.Drawing.Point(this.Width - buttonX - 40, this.Height / 10 * 8 - buttonY - 20);
            login.Height = buttonY;
            login.Width = buttonX;
            login.Anchor = (AnchorStyles.Bottom | AnchorStyles.Right);
            login.BackColor = color_blue;
            login.ForeColor = Color.Gold;
            login.Text = "Login";
            login.Click += new EventHandler(multiMenu_Click);
