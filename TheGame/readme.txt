...
-------------------------
    update by iL (Version 4.2)
    - Added 2 versions of DirectDraw by aqrit, with autodetecting comptibility
    - Added some minor fixes for Windows 8/10 comptibility
...
Idea and first versions by zzzKOTzzz, 
   ...
   The Warcraft II player community: http://server.war2.ru
...
tips on optimizing performance, visit http://www.blizzard.com/support
